...
void domove(int, float[], double[], float[], double);

void dscal(int, double, double[], int);

void fcc(float[], int, int, double);

__global__ void forces(float* x, float side, float rcoff, double* globalEpot,double* globalVir, float* globalF);
 ...
 */
  void
  domove(int n3, float x[], double vh[], float f[], double side){
    int i;
 ...
 */
  void
  fcc(float x[], int npart, int mm, double a){
    int ijk=0;
    int i,j,k,lg;
